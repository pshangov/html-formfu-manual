...
In which you will learn to harness the power of HTML::FormFu models, and build comlex content management applications in a snap.

=item Chapter VI: L<HTML::FormFu::Manual::Ajax>

In which you will be shown tips and tricks about how to work with forms which are dynamically modified on the client side.
